...
export function BriefingDashboard() {
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-yellow-500/30 bg-yellow-500/10 p-3 text-xs text-yellow-200 break-all">
            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-center justify-between space-x-2 bg-white/5 p-3 rounded-lg">
                  <Label htmlFor="market-insights" className="text-sm cursor-pointer">
                    {t.marketInsights}
                  </Label>
                  <Checkbox
                    id="market-insights"
                ...
                <div className="flex items-center justify-between space-x-2 bg-white/5 p-3 rounded-lg">
                  <Label htmlFor="change-analysis" className="text-sm cursor-pointer">
                    {t.changeAnalysis}
                  </Label>
                  <Checkbox
                    id="change-analysis"
